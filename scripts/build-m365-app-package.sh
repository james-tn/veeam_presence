...
M365_APP_FULL_DESCRIPTION="${M365_APP_FULL_DESCRIPTION:-I track daily attendance across every Veeam office worldwide. Ask me about headcounts, leaderboards, trends, cross-office travel, team coordination, manager impact, and individual patterns. 17 offices, ~3,000 people, refreshed daily.}"
